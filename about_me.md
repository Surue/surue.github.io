...
<div style="float:left; width: 70%; box-sizing:border-box; padding: 10px;">
	<div class="box">
		...
		small engine where my main task was to implement Vulkan. Finally during my last year I've led a team and together we made a full <a href="projects/pok_engine.html">3D engine</a> 
		that could be run on a pc and on the Nintendo Switch.</p>
	</div>
	<div class="box" style="margin-top: 20px;">
		...
		<div>
			...
			<p>Since September 2019 and after a first trial between March and June of the same year, I became a teacher at <a href="https://www.sae.swiss/">my school</a>. I'm in charge of most of the classes for the 
		...
		<div>
			...
			<p>I worked at <a href="https://team-kwakwa.com/">Team KwaKwa</a> on their yet non-announced game. My main task was to work on an <b>open-world featuring islands and pirates</b>. The goal for me was to quickly 
		...
		<div>
			...
			<p>I worked at Oniroforge to help them finish their game. It was a <b>VR game</b> on the Occulus rift and the Samsung Gear VR. I was in charge of
	...
	<div class="box" style="margin-top: 20px;">
		...
		<div>
			...
			<div class="sub-data">Since 2018</div>
			<iframe src="https://www.youtube.com/embed/4IqqYseWubY"></iframe>
