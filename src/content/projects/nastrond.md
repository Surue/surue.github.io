---
title: Nastrond
description: School project about AI, behavior trees, and pathfinding in a dwarf city builder built on a custom C++ engine.
excerpt: A three-month school project where we built a city builder with dwarfs.
...
The repository is available on [GitHub](https://github.com/Toadsword/Nastrond/tree/develop).