export const aboutSections = [
    ...
    { id: 'projects', label: 'Highlighted projects' },
...
export const experiences = [
    {
        ...
        title: 'Associate Lead Programmer',
        company: 'Old Skull Games',
        href: 'https://oldskullgames.com/',
        description:
    ...
    {
        period: '2024 - Present',
        title: 'Occasional Trainer',
        company: 'Game Sup',
        href: 'https://game-sup.fr/',
        description:
            'Delivering focused training modules, including procedural generation applied to roguelike projects.',
        tags: ['unity', 'pcg'],
    },
    {
        ...
        href: 'https://oldskullgames.com/',
        description:
            'Building tools, shared frameworks, and production-facing quality-of-life systems in Unity while working closely with level design, audio, and content workflows.',
        tags: ['tools', 'unity'],
    },
    {
        ...
        href: 'https://oldskullgames.com/',
        description:
            'Gameplay work on mobile free-to-play titles, including enemy behaviors, bosses, game modes, and systemic content support.',
        tags: ['ai', 'unity', 'pcg'],
    },
    {
        period: 'Sep 2019 - Sep 2020',
        title: 'Supervisor Game Programming Section',
        company: 'SAE Institute Geneva',
        href: 'https://www.sae.edu/ch-ge/',
        description:
            'Teaching advanced procedural generation and AI while also mentoring first-year students on Unity and C++ fundamentals.',
        tags: ['ai', 'unity', 'pcg'],
    },
    {
        period: 'Feb 2019 - Apr 2019',
        title: 'Teacher Game Programming',
        company: 'SAE Institute Geneva',
        href: 'https://www.sae.edu/ch-ge/',
        description:
            'Teaching modules on procedural generation, AI, mathematics, and physics, including a final assignment to build a 2D physics engine in C++.',
        tags: ['ai', 'unity', 'pcg'],
    },
    {
        ...
        href: 'https://team-kwakwa.com/',
        description:
            'Working on prototype world building, procedural generation, AI behaviors, and dialogue tooling while also presenting the project at industry events.',
        tags: ['ai', 'unity', 'pcg'],
    },
    {
        period: 'May 2018',
        title: 'Gameplay Programmer',
        company: 'Oniro Forge',
        href: 'https://www.facebook.com/Oniroforge/',
        description:
            'First professional game development role on a small VR project, with contributions across features, scenes, and enemy behavior work.',
        tags: ['ai', 'unity'],
    },
];

export const highlightedProjectSlugs = [
    'cryptical-path',
...
export const skillCards = [
    {
        ...
        icon: '/assets/images/about/icon_code.png',
        items: [
    ...
    {
        title: 'Soft skills',
        icon: '/assets/images/about/soft_skills.png',
        items: [
    ...
    {
        title: 'C#',
        icon: '/assets/images/about/Logo_C_sharp.svg.png',
        items: [
    ...
    {
        title: 'Developer UX',
        icon: '/assets/images/about/ui_ux_icon.png',
        items: [
    ...
    {
        title: 'Unity',
        icon: '/assets/images/about/Logo_Unity.png',
        items: [
    ...
    },
    {
        ...
        icon: '/assets/images/about/methode_agile.png',
        items: [
    ...
    {
        title: 'C++',
        icon: '/assets/images/about/ISO_C++_Logo.svg.png',
        items: [
    ...
    },
    {
        ...
        icon: '/assets/images/about/jira.svg',
        items: [
    ...
    {
        title: 'Git',
        icon: '/assets/images/about/Git_icon.png',
        items: [
